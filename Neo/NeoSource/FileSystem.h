...
typedef FastDelegate::FastDelegate2<class FileSystem*, const String&> FileSystem_FileChangeCallback;
typedef FastDelegate::FastDelegate1<const String&, bool> FileSystem_FilenameFilterDelegate;
